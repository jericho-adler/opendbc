...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    # LCA_3 message at 67 Hz (send 2 out of every 3 frames = 66.67 Hz)
    if (self.frame % 3) < 2:
      ...
      if self.lca_3_timer_initialized:
        ...
        can_sends.append(create_lca_3_control(self.packer, CC.latActive, apply_torque, CS.msg_lca_3,
                                                  self.lca_3_timer_1, self.lca_3_timer_2))
